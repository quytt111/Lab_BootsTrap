            ...
            <div class="col-sm-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-info" @click="Change1">Xem chi tiết </button>
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
            ...
            <div class="col-sm-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text text-justify">{{ items[2].content }}</p>
                        <button class="btn btn-info">Xem chi tiết </button>
                    </div>
                </div>
            </div>
...
const items = ([
    ...
    { title: 'Các loại gia vị tốt cho sức khỏe', content: 'Một số loại gia vị cung cấp nhiều polyphenol chống oxy hóa cao hơn các loại gia vị quen thuốc khác, với một lượng nhỏ các món ăn đã thêm hương thơm và vị hấp dẫm....', image: img2 },
